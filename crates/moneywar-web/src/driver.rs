...
//! üstüne ince bir sarmalayıcı. Kendi state'ini sahiplenir.
...
fn next_seed(base: u64, season: u64) -> u64 {
    base.wrapping_mul(0x9E37_79B9_7F4A_7C15).wrapping_add(season.wrapping_mul(0x1234_5678_9ABC_DEF1))
}
...
impl SimDriver {
    ...
    #[must_use]
    pub fn new(base_seed: u64, season_ticks: u32, seconds_per_tick: u32, difficulty: Difficulty) -> Self {
    ...
    pub fn step(&mut self) {
        ...
        let cmds = decide_all_npcs(&self.state, &mut rng, next_tick, self.difficulty);
